...
from mem0_naver.configs.base import MemoryConfig, MemoryItem
from mem0_naver.configs.enums import MemoryType
from mem0_naver.configs.prompts import (
    PROCEDURAL_MEMORY_SYSTEM_PROMPT,
    get_update_memory_messages,
)
from mem0_naver.memory.base import MemoryBase
from mem0_naver.memory.setup import mem0_dir, setup_config
from mem0_naver.memory.storage import SQLiteManager
from mem0_naver.memory.telemetry import capture_event
from mem0_naver.memory.utils import (
...
from mem0_naver.utils.factory import EmbedderFactory, LlmFactory, VectorStoreFactory


eirene_logger = logging.getLogger("Eirene")
...
class Memory(MemoryBase):
    def __init__(self, config: MemoryConfig = MemoryConfig()):
        ...
        if self.config.graph_store.config:
            if self.config.graph_store.provider == "memgraph":
                from mem0_naver.memory.memgraph_memory import MemoryGraph
            elif self.config.graph_store.provider == "neptune":
                from mem0_naver.graphs.neptune.main import MemoryGraph
            else:
                from mem0_naver.memory.graph_memory import MemoryGraph
        ...
        if self.config.vector_store.provider in ["faiss"]:
        ...
        capture_event("mem0_naver.init", self, {"sync_type": "sync"})
    ...
    def get(self, memory_id):
        ...
        """
        capture_event(
            "mem0_naver.get", self, {"memory_id": memory_id, "sync_type": "sync"}
        )
    ...
    def update(self, memory_id, data):
        ...
        """
        capture_event(
            "mem0_naver.update", self, {"memory_id": memory_id, "sync_type": "sync"}
        )
    ...
    def delete(self, memory_id):
        ...
        """
        capture_event(
            "mem0_naver.delete", self, {"memory_id": memory_id, "sync_type": "sync"}
        )
    ...
    def history(self, memory_id):
        ...
        """
        capture_event(
            "mem0_naver.history", self, {"memory_id": memory_id, "sync_type": "sync"}
        )
    ...
    def _create_procedural_memory(self, messages, metadata=None, prompt=None):
        ...
        capture_event(
            "mem0_naver._create_procedural_memory",
            self,
            {"memory_id": memory_id, "sync_type": "sync"},
        )
    ...
    def reset(self):
        ...
        capture_event("mem0_naver.reset", self, {"sync_type": "sync"})
...
class AsyncMemory(MemoryBase):
    def __init__(self, config: MemoryConfig = MemoryConfig()):
        ...
        capture_event("mem0_naver.init", self, {"sync_type": "async"})
    ...
    async def _add_to_vector_store(
        ...
        try:
            response = remove_code_blocks(response)
            response = extract_json(response)
            eirene_logger.debug(f"[mem0-naver] LTM JSON summary: {response}")
            new_retrieved_facts = json.loads(response)["facts"]
        except Exception as e:
            logger.error(f"Error in new_retrieved_facts: {e}")
            new_retrieved_facts = []
        ...
        if new_retrieved_facts:
            ...
            try:
                ...
                new_memories_with_actions = json.loads(response)
                eirene_logger.debug(
                    f"[mem0-naver] LTM JSON actions: {new_memories_with_actions}"
                )
            except Exception as e:
                logger.error(f"Invalid JSON response: {e}")
                new_memories_with_actions = {}
    ...
    async def get(self, memory_id):
        ...
        """
        capture_event(
            "mem0_naver.get", self, {"memory_id": memory_id, "sync_type": "async"}
        )
    ...
    async def update(self, memory_id, data):
        ...
        """
        capture_event(
            "mem0_naver.update", self, {"memory_id": memory_id, "sync_type": "async"}
        )
    ...
    async def delete(self, memory_id):
        ...
        """
        capture_event(
            "mem0_naver.delete", self, {"memory_id": memory_id, "sync_type": "async"}
        )
    ...
    async def history(self, memory_id):
        ...
        """
        capture_event(
            "mem0_naver.history", self, {"memory_id": memory_id, "sync_type": "async"}
        )
    ...
    async def reset(self):
        ...
        capture_event("mem0_naver.reset", self, {"sync_type": "async"})
